...
function App() {
  const productList = [
          ...
          {type: "Truck", price: 29000, brand: "Ram",  model:"3500", imgID: "/images/Ram_3500.png" , cartID: 5, description: "Upgraded truck for our more experienced drivers"},
          ...
          {type: "Sport", price: 200000, brand: "Porsche",  model:"Spyder", imgID: "/images/Porsche_Spyder.png" , cartID: 12, description: "A car that will cause most other cars (and checkbooks) a run for their money"},
          {type: "Sport", price: 100000, brand: "BMW",  model:"M5", imgID: "/images/BMW_M5.png" , cartID: 13, description: "I personally guarentee that after buying this car, you will never want to buy another car again"},
